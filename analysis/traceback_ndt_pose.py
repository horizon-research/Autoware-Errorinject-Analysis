...
def find_injection_range(filename):
    ...
    flag = 0
    ori_xp, ori_yp, ori_zp, ori_xo, ori_yo, ori_zo, ori_wo = parse_ndt('/localdisk/autoware_attack_sdc/baseline148/ndt_pose.txt')
    if signal == 'xp':
...
def main():
    ...
    parser.add_argument('--base', default='ndt_pose_attack_sdc')
    ...
    for i in range(len(f)):
        ...
        xp_ndt,yp_ndt,zp_ndt,xo_ndt,yo_ndt,zo_ndt,wo_ndt = parse_ndt(f[i][:-4]+'/ndt_pose.txt')
