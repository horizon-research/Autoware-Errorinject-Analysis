...
def find_injection_range(filename):
    ...
    flag = 0
    ori_xl, ori_yl, ori_zl, ori_xa, ori_ya, ori_za = parse_es_twist('/localdisk/autoware_attack_sdc/baseline148/estimate_twist.txt')
    if signal == 'xl':
...
def main():
    ...
    parser.add_argument('--base', default='estimate_twist_attack_sdc')
    ...
    for i in range(len(f)):
        ...
        xl_es,xa_es,yl_es,ya_es,zl_es,za_es = parse_es_twist(f[i][:-4]+'/estimate_twist.txt')
