...
def main():
    ...
    parser.add_argument('--base', default='pose_relay_attack_generalregis')
    parser.add_argument('--save', default='pose_relay.pkl')
    ...
    for i in range(1,len(f)):
        ...
        #pdb.set_trace()
        os.system(cmd)
        xp,yp,zp,xo,yo,zo,wo = parse_ndt('tmp/current_pose.txt')
        cmd = 'rm -r tmp'
        os.system(cmd)
        #pdb.set_trace()
