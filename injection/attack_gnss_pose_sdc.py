...
def main():
	...
	#pdb.set_trace()
	signal_attack = ['xp','yp','zp','xo','zo','wo']
	...
	for sig in signal_attack:
		if sig == 'xp':
			...
			for i in range(0,32):
				...
				time.sleep(18)
				error_num = bitflip(ori_num,i)
				cmd = '''rostopic pub --once /gnss_pose geometry_msgs/PoseStamped "{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}"''' % (error_num,ype,zpe,xoe,yoe,zoe,woe)
				os.system(cmd)
				time.sleep(33)
				for t in pid:
			...
			for i in range(0,32):
				...
				time.sleep(18)
				error_num = bitflip(ori_num,i)
				cmd = '''rostopic pub --once /gnss_pose geometry_msgs/PoseStamped "{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}"''' % (xpe,error_num,zpe,xoe,yoe,zoe,woe)
				os.system(cmd)
				time.sleep(33)
				for t in pid:
					os.kill(t,signal.SIGINT)
			...
			for i in range(0,32):
				...
				time.sleep(18)
				error_num = bitflip(ori_num,i)
				cmd = '''rostopic pub --once /gnss_pose geometry_msgs/PoseStamped "{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}"''' % (xpe,ype,error_num,xoe,yoe,zoe,woe)
				os.system(cmd)
				time.sleep(33)
				for t in pid:
					os.kill(t,signal.SIGINT)
			...
			for i in range(0,32):
				...
				time.sleep(18)
				error_num = bitflip(ori_num,i)
				cmd = '''rostopic pub --once /gnss_pose geometry_msgs/PoseStamped "{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}"''' % (xpe,ype,zpe,error_num,yoe,zoe,woe)
				os.system(cmd)
				time.sleep(33)
				for t in pid:
					os.kill(t,signal.SIGINT)
			...
			for i in range(0,32):
				...
				time.sleep(18)
				error_num = bitflip(ori_num,i)
				cmd = '''rostopic pub --once /gnss_pose geometry_msgs/PoseStamped "{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}"''' % (xpe,ype,zpe,xoe,error_num,zoe,woe)
				os.system(cmd)
				time.sleep(33)
				for t in pid:
					os.kill(t,signal.SIGINT)
			...
			for i in range(0,32):
				...
				time.sleep(18)
				error_num = bitflip(ori_num,i)
				cmd = '''rostopic pub --once /gnss_pose geometry_msgs/PoseStamped "{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}"''' % (xpe,ype,zpe,xoe,yoe,error_num,woe)
				os.system(cmd)
				time.sleep(33)
				for t in pid:
					os.kill(t,signal.SIGINT)
			...
			for i in range(0,32):
				...
				time.sleep(18)
				error_num = bitflip(ori_num,i)
				cmd = '''rostopic pub --once /gnss_pose geometry_msgs/PoseStamped "{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}"''' % (xpe,ype,zpe,xoe,yoe,zoe,error_num)
				os.system(cmd)
				time.sleep(33)
				for t in pid:
					os.kill(t,signal.SIGINT)
