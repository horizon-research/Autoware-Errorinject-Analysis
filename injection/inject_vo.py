                ...
                for delta in error:
                    ...
                    if ss == 'xp':
                        ...
                        if args.iter is False:
                            cmd = '''rostopic pub --once /vehicle/odom nav_msgs/Odometry "{'pose':{'pose':{'position':{'x': %f, 'y': %f, 'z': %f},'orientation':{'x': %f,'y': %f, 'z': %f, 'w': %f}}}}"''' % (injectxp,yp,zp,xo,yo,zo,wo)
